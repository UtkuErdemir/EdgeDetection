...
public class MainActivity extends CameraActivity implements CvCameraViewListener2, OnTouchListener {
    ...
    private UtkuCameraView mOpenCvCameraView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (UtkuCameraView) findViewById(R.id.tutorial3_activity_java_surface_view);
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        greyMat=new Mat(width,height,CvType.CV_8UC1);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        //Imgproc.Canny(inputFrame.gray(), edge, 225, 250);
        Imgproc.cvtColor(mRgbaT,greyMat,Imgproc.COLOR_BGR2GRAY);
        Imgproc.Canny(greyMat,cannyImg,100,80);
        return cannyImg;
    }
